...
public class TestMovieRental {
    ...
    public void test2() {
		...
		StringBuilder ans2 = new StringBuilder("Rental Record for Mary\n");
		ans2.append("\tOz The Great and Powerful\t3.0\n");
		ans2.append("\tWreck-it Ralph\t9.0\n");
		ans2.append("Amount owed is 12.0\n");
		ans2.append("You earned 2 frequent renter points");
    ...
    public void test3() {
		...
		StringBuilder ans3 = new StringBuilder("Rental Record for Manny\n");
		ans3.append("\tThe Dark Knight\t2.0\n");
		ans3.append("\tWreck-it Ralph\t1.5\n");
		ans3.append("Amount owed is 3.5\n");
		ans3.append("You earned 2 frequent renter points");
        
        String ans = ans3.toString();
